...
// The charmstore package is capable of storing and updating charms in a
// MongoDB database, as well as maintaining further information about them such
// as the VCS revision the charm was loaded from and the URLs for the charms.
package charmstore
