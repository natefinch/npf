...
type NewAPIHandler func(*Store, *params.HandlerConfig) http.Handler
...
func NewServer(db *mgo.Database, config *params.HandlerConfig, versions map[string]NewAPIHandler) (http.Handler, error) {
	if len(versions) == 0 {
